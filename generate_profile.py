...
INFO = [
    ("__header__", "fayne bagaipo", ""),
    ("__rule__", "", ""),
    ("Role",     "Technical Account Manager @ TrustArc, Cebu", "val"),
    ("Edu",      "BSCS, UP - Cebu  ·  Class of 2023", "val"),
    ("Focus",    "AI/Web Development  ·  Agentic AI / LLMs / Full Stack", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",     "Python · C/C++ · JavaScript · HTML", "CSS"),
    ("Frontend",  "VueJS · React · Angular · TailwindCSS · Bootstrap", "val"),
    ("Backend",  "Django · FastAPI · Node.js · Express.js · REST", "val"),
    ("AI",       "LLMs · RAG · LangChain · Vector DBs", "val"),
    ("Data",     "PostgreSQL · MongoDB · Redis · GraphQL", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("WebMart",     "A full-featured e-commerce platform with", "warn"),
    ("",         "real-time cart management and multi-store support", "warn"),
    ("MovieHub", "Search thousands of movies using TMDB", "warn"),
    ("RESTAPI", "Scalable REST API with authentication,", "warn"),
    ("",         "rate limiting, and API documentation", "warn"),
    ("FaceDetect", "Real-time face mask detection,", "warn"),
    ("",         "using SSD and ResNet50", "warn"),
    ("__blank__", "", ""),
    ("__section__", "~/highlights", ""),
    ("Award",    "Cum laude · 2023 UP Cebu", "val"),
    ("__stats__", "", ""),
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Portfolio",      "fayne-dev.vercel.app", "accent"),
    ("In",       "linkedin.com/in/fabagaipo", "accent"),
    ("Mail",     "bagaipofayne@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to Full Stack / AI Developer roles</tspan>'
